 ...
 * 
 */
public class TextRavensProblem {
    private String problemType;
    private HashMap<String, TextRavensFigure> figures;
    private String name;
...
//    private boolean answerReceived=false;
     ...
     */
    public TextRavensProblem(String name,String problemType) {
        this.name=name;
...
//    }
     ...
     * problem.
     * 
     * The value for each key is the TextRavensFigure corresponding to that figure
     * of the problem.
     * 
     ...
     */
    public HashMap<String, TextRavensFigure> getFigures() {
        return figures;
    }
    /**
